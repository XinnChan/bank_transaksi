...
<html lang="en">
  ...
  <body class="bg-dark">
    <div class="container-hp border border-dark shadow-lg text-left">
      ...
      <div class="logo-bank">
        <img src="../../image/HLB.webp" class="w-100 position-relative"  alt="Logo-HongLeongBank">
      </div>
      <div class="text d-flex align-items-center">
<div  style="background-color: #1664BC; width:4em; height:0.2em; border-radius: 10px;"></div>&nbsp;&nbsp;&nbsp;<h5 style="color: #1664BC; font-family: 'Poppins',sans-serif ; font-weight: bold;" class="text-1xl">BANK HongLeong </h5>
      </div>
